...
async function renderSiteGallery() {
        ...
        galleryGrid.innerHTML = `
            <div class="gallery-item">
                ...
                <div class="gallery-overlay">
                    <h4 data-translate="gal-ph-ice">Ледовая арена</h4>
                    <p data-translate="gal-ph-ice-desc">Тренировки по хоккею</p>
                </div>
            </div>
            <div class="gallery-item">
                <div class="gallery-image">
                ...
                <div class="gallery-overlay">
                    <h4 data-translate="gal-ph-gym">Спортивный зал</h4>
                    <p data-translate="gal-ph-gym-desc">Соревнования по баскетболу</p>
                </div>
            </div>
            <div class="gallery-item">
                <div class="gallery-image">
                ...
                <div class="gallery-overlay">
                    <h4 data-translate="gal-ph-stad">Стадион</h4>
                    <p data-translate="gal-ph-stad-desc">Футбольные матчи</p>
                </div>
            </div>
            <div class="gallery-item">
                <div class="gallery-image">
                ...
                <div class="gallery-overlay">
                    <h4 data-translate="gal-ph-fit">Тренажерный зал</h4>
                    <p data-translate="gal-ph-fit-desc">Современное оборудование</p>
                </div>
            </div>
        `;
    ...
    galleryGrid.innerHTML = uploadedImages.map((image) => `
        <div class="gallery-item">
            <div class="gallery-image">
...
function setupAdminAccess() {
    ...
    const showAdmin = params.get('admin') === '1' || params.get('admin') === 'true';
    const btn = document.getElementById('adminNavBtn');
    if (!btn) return;
    if (showAdmin) {
        btn.classList.remove('admin-btn-hidden');
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    window.addEventListener('gorkiLanguageChanged', () => {
...
function hideAllSections() {
    ...
    const pricesSec = document.getElementById('pricesSection');
    ...
    pricesList.innerHTML = priceAdminItems.map((price, index) => `
        <div class="price-edit-row">
            <div class="row-grid">
                ...
                <button type="button" class="admin-btn secondary" style="padding:0.5rem;" onclick="deletePriceAdmin(${index})">
            ...
            <div style="display:flex;justify-content:flex-end;margin-top:0.5rem;">
                <button type="button" class="admin-btn" style="padding:0.35rem 0.75rem;font-size:0.875rem;" onclick="savePriceItemAdmin(${index}, this)">
...
async function saveGallery() {
    ...
    try {
        ...
        if (simpleSave('gorkiGallery', allImages)) {
            ...
            newGalleryImages = [];
            await renderSiteGallery();
            alert('Галерея сохранена локально (база данных недоступна)');
            clearGalleryPreview();
            renderGalleryCurrent();
        } else {
...
async function initVisitorHub() {
    ...
    if (bookingForm && bookingStatus) {
        bookingForm.addEventListener('submit', async (e) => {
            ...
            if (!payload.name || !payload.phone || !payload.facility || !payload.date) {
                bookingStatus.classList.add('error');
